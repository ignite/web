export default function IgntTimesIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path d="M6 12H10H42" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path
      ...
      />
      <path d="M20 22V34" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M28 22V34" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
