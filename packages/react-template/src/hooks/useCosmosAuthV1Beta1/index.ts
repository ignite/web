...
export default function useCosmosAuthV1Beta1() {
  ...
  return {QueryAccounts,QueryAccount,QueryAccountAddressByID,QueryParams,QueryModuleAccounts,QueryBech32Prefix,QueryAddressBytesToString,QueryAddressStringToBytes,
  }
}