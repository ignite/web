    ...
    <div class="container">
      ...
      <div style="max-width: 600px">
              ...
              <template v-slot:dropdown>
                <div style="width: 160px">
                  ...
                  <div
                    class="dropdown-option"
                    style="color: #d80228"
                    @click="visibleModal = 'delete-post'"
                  >
                    Delete
                  </div>
                </div>
        ...
        <div v-if="posts.length === 0" style="text-align: center">
          <SpSpacer size="md" />
          <SpTypography size="md"> No post items </SpTypography>
    ...
    const posts = [
      {
        ...
        title: 'Relay nodes',
        description:
          'Therefore, relay nodes require significantly more power and are only',
