  ...
  actions: {
    ...
    async QueryAccounts(
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryAccounts({
              ...query,
        ...
        throw new Error(
          'QueryClient:QueryAccounts API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryAccount(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryAccount API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
