...
export { Module, Validator, VersionInfo }
  ...
  actions: {
    ...
    async ServiceGetNodeInfo(
      ...
      try {
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'ServiceGetNodeInfo',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getGetNodeInfo']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:ServiceGetNodeInfo API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async ServiceGetSyncing(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'ServiceGetSyncing',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getGetSyncing']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:ServiceGetSyncing API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async ServiceGetLatestBlock(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'ServiceGetLatestBlock',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getGetLatestBlock']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:ServiceGetLatestBlock API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async ServiceGetBlockByHeight(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'ServiceGetBlockByHeight',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getGetBlockByHeight']({ params: { ...key }, query }) ?? {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:ServiceGetBlockByHeight API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async ServiceGetLatestValidatorSet(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.serviceGetLatestValidatorSet({
              ...query,
        ...
        commit('QUERY', {
          query: 'GetLatestValidatorSet',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'ServiceGetLatestValidatorSet',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getGetLatestValidatorSet']({ params: { ...key }, query }) ??
          {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:ServiceGetLatestValidatorSet API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async ServiceGetValidatorSetByHeight(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.serviceGetValidatorSetByHeight(key.height, query)
        ).data
        ...
        while (
          ...
          let next_values = (
            await queryClient.serviceGetValidatorSetByHeight(key.height, {
              ...query,
              'pagination.key': (<any>value).pagination.next_key
            })
          ).data
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'ServiceGetValidatorSetByHeight',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getGetValidatorSetByHeight']({
            params: { ...key },
            query
          }) ?? {}
        )
        ...
        throw new Error(
          'QueryClient:ServiceGetValidatorSetByHeight API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    }
