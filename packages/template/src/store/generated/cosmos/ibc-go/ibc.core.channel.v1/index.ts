  ...
  actions: {
    ...
    async QueryChannel(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryChannel API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryChannels(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryChannels API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryConnectionChannels(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryConnectionChannels API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryChannelClientState(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryChannelClientState API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryChannelConsensusState(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryChannelConsensusState API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryPacketCommitment(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryPacketCommitment API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryPacketCommitments(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryPacketCommitments API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryPacketReceipt(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryPacketReceipt API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryPacketAcknowledgement(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryPacketAcknowledgement API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryPacketAcknowledgements(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryPacketAcknowledgements API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryUnreceivedPackets(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryUnreceivedPackets API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryUnreceivedAcks(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryUnreceivedAcks API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryNextSequenceReceive(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryNextSequenceReceive API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    }
