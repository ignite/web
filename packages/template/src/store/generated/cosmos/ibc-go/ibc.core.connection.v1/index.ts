  ...
  actions: {
    ...
    async QueryConnection(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryConnection API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryConnections(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryConnections API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryClientConnections(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryClientConnections API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryConnectionClientState(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryConnectionClientState API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryConnectionConsensusState(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryConnectionConsensusState API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    }
