...
const baseMainnetVestingAccount = { campaignID: 0, address: "" };
export const MainnetVestingAccount = {
    encode(message, writer = Writer.create()) {
        ...
        if (message.vestingOptions !== undefined) {
            ShareVestingOptions.encode(message.vestingOptions, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        const message = { ...baseMainnetVestingAccount };
...
const baseShareVestingOptions = {};
export const ShareVestingOptions = {
    encode(message, writer = Writer.create()) {
        if (message.delayedVesting !== undefined) {
            ShareDelayedVesting.encode(message.delayedVesting, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseShareVestingOptions };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.delayedVesting = ShareDelayedVesting.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.delayedVesting !== undefined && object.delayedVesting !== null) {
            message.delayedVesting = ShareDelayedVesting.fromJSON(object.delayedVesting);
        }
        else {
    ...
    fromPartial(object) {
        const message = { ...baseShareVestingOptions };
        if (object.delayedVesting !== undefined && object.delayedVesting !== null) {
            message.delayedVesting = ShareDelayedVesting.fromPartial(object.delayedVesting);
        }
        else {
            message.delayedVesting = undefined;
        }
...
const baseShareDelayedVesting = { endTime: 0 };
export const ShareDelayedVesting = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseShareDelayedVesting };
        message.totalShares = [];
        message.vesting = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
