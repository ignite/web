...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryChainAll = (query, params = {}) => this.request({
         ...
         */
        this.queryChain = (launchID, params = {}) => this.request({
         ...
         */
        this.queryGenesisAccountAll = (launchID, query, params = {}) => this.request({
         ...
         */
        this.queryGenesisAccount = (launchID, address, params = {}) => this.request({
         ...
         */
        this.queryGenesisValidatorAll = (launchID, query, params = {}) => this.request({
         ...
         */
        this.queryGenesisValidator = (launchID, address, params = {}) => this.request({
         ...
         */
        this.queryRequestAll = (launchID, query, params = {}) => this.request({
         ...
         */
        this.queryRequest = (launchID, requestID, params = {}) => this.request({
         ...
         */
        this.queryVestingAccountAll = (launchID, query, params = {}) => this.request({
         ...
         */
        this.queryVestingAccount = (launchID, address, params = {}) => this.request({
