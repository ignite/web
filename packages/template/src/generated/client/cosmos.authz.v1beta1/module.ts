...
class Module extends Api<any> {
	...
	async sendMsgRevoke({ value, fee, memo }: sendMsgRevokeParams): Promise<DeliverTxResponse> {
		...
		if (!this._addr) {
            throw new Error('TxClient:sendMsgRevoke: Unable to sign Tx. Address is not present.')
        }
		try {
	...
	async sendMsgGrant({ value, fee, memo }: sendMsgGrantParams): Promise<DeliverTxResponse> {
		...
		if (!this._addr) {
            throw new Error('TxClient:sendMsgGrant: Unable to sign Tx. Address is not present.')
        }
		try {
	...
	async sendMsgExec({ value, fee, memo }: sendMsgExecParams): Promise<DeliverTxResponse> {
		...
		if (!this._addr) {
            throw new Error('TxClient:sendMsgExec: Unable to sign Tx. Address is not present.')
        }
		try {
