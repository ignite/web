...
type SendMsgDepositWithinBatchType =
  typeof Module.prototype.sendMsgDepositWithinBatch
type SendMsgWithdrawWithinBatchType =
  typeof Module.prototype.sendMsgWithdrawWithinBatch
...
type QueryLiquidityPoolByPoolCoinDenomType =
  typeof Module.prototype.queryLiquidityPoolByPoolCoinDenom
type QueryLiquidityPoolByReserveAccType =
  typeof Module.prototype.queryLiquidityPoolByReserveAcc
type QueryLiquidityPoolBatchType =
  typeof Module.prototype.queryLiquidityPoolBatch
...
type QueryPoolBatchDepositMsgsType =
  typeof Module.prototype.queryPoolBatchDepositMsgs
type QueryPoolBatchDepositMsgType =
  typeof Module.prototype.queryPoolBatchDepositMsg
type QueryPoolBatchWithdrawMsgsType =
  typeof Module.prototype.queryPoolBatchWithdrawMsgs
type QueryPoolBatchWithdrawMsgType =
  typeof Module.prototype.queryPoolBatchWithdrawMsg
...
function useModule(): Response {
  ...
  sendMsgDepositWithinBatch = sendMsgDepositWithinBatch.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  sendMsgWithdrawWithinBatch = sendMsgWithdrawWithinBatch.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  sendMsgSwapWithinBatch = sendMsgSwapWithinBatch.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  sendMsgCreatePool = sendMsgCreatePool.bind(gaia.tendermintLiquidityV1Beta1)

  queryLiquidityPools = queryLiquidityPools.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryLiquidityPool = queryLiquidityPool.bind(gaia.tendermintLiquidityV1Beta1)

  queryLiquidityPoolByPoolCoinDenom = queryLiquidityPoolByPoolCoinDenom.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryLiquidityPoolByReserveAcc = queryLiquidityPoolByReserveAcc.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryLiquidityPoolBatch = queryLiquidityPoolBatch.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryPoolBatchSwapMsgs = queryPoolBatchSwapMsgs.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryPoolBatchSwapMsg = queryPoolBatchSwapMsg.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryPoolBatchDepositMsgs = queryPoolBatchDepositMsgs.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryPoolBatchDepositMsg = queryPoolBatchDepositMsg.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryPoolBatchWithdrawMsgs = queryPoolBatchWithdrawMsgs.bind(
    gaia.tendermintLiquidityV1Beta1
  )

  queryPoolBatchWithdrawMsg = queryPoolBatchWithdrawMsg.bind(
    gaia.tendermintLiquidityV1Beta1
  )
